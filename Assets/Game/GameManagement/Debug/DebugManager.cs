...
public class DebugManager : MonoBehaviour
{
    ...
    [Header("Player position points")]
    [SerializeField] private bool doDrawPositionPoints = false;
    [SerializeField] private int pointsPerSecond = 10;
    private float timeTillNextPoint;
    ...
    void Start()
    {
        ...
        if (doDrawPositionPoints)
            timeTillNextPoint = 1f / (float) pointsPerSecond;
    }
